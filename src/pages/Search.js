    ...
    <div className=''>
        ...
        <div className='h-[80vh] flex flex-col justify-center items-center'>
            <div className="relative"> 
                ...
                <input type="text" className="h-14 w-96 pl-10 pr-20 rounded-lg z-0 focus:shadow focus:outline-none" placeholder="Enter an city name" name="city" onChange={e=>setCity(e.target.value)}/>
