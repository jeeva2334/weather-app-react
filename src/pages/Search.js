    ...
    <div className=''>
        ...
        <div className='h-[80vh] flex flex-col justify-center items-center'>
            <div class="relative"> 
                ...
                <input type="text" class="h-14 w-96 pl-10 pr-20 rounded-lg z-0 focus:shadow focus:outline-none" placeholder="City name here" name="city" onChange={e=>setCity(e.target.value)}/>
                <div class="absolute top-2 right-2">
                    <button class="h-10 w-20 text-white rounded-lg bg-[#2e3239] hover:bg-[#282b30]" onClick={()=>search()}>Search</button>
                </div>
            </div>
